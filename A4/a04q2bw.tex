...
\noindent{\bf Proof by structural induction} Consider only the left-related rotations, since the cases and arguments for the right are symmetric to those of the left.
